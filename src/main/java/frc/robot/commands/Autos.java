...
// }
  ...
  public static Command driveOut(SwerveDriveBase drivetrain) {
    return new SequentialCommandGroup(
//        new InstantCommand(algaeArm::retract),
//        new InstantCommand(elevator::retract),
        new RunCommand(() -> drivetrain.inputDrivingX_Y(
...
//  }
  ...
  private static Command centerOnAprilTag(SwerveDriveBase drivetrain) {
    return new SequentialCommandGroup(
 ...
 //           .withTimeout(3),
  ...
  /** Goes up to apriltag, hits the wall to become parallel, then backs up */
  private static Command centerOnAprilTagFiltered(SwerveDriveBase drivetrain, int... ids) {
    return new SequentialCommandGroup(
